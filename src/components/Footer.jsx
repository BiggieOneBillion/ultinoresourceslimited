...
const Footer = () => {
    const {handleSetDigit, digits} = useGlobal()
  const navigate = useNavigate()
    // const fn = navigate('/services')
    const handleWork = (num) => {
    handleSetDigit(num)
    navigate('/services')
  }
//   console.log(digits);
    ...
    <div>
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <span className="rounded bg-primaryOrange lg:block lg:h-1 lg:w-10"></span>

                <div className="text-center lg:text-left">
                    <h2 className="text-2xl font-medium text-white">Subscribe To Our Newsletter</h2>

                    <p
                    className="mx-auto mt-4 max-w-md text-sm leading-relaxed text-gray-400 lg:mx-0"
                    >
                    To receive news and updates, kindly subcribe to our newsletter.
                    </p>
                </div>
                ...
                <form className="mt-6">
                    ...
                    <button
                        type="button"
                        className="absolute top-1/2 right-1.5 -translate-y-1/2 rounded bg-primaryOrange p-3 text-white transition hover:bg-[#FF884B]"
                    >
            ...
            <div className="pt-16 pb-8 lg:pt-24 lg:pr-12">
                ...
                <h1 className='text-2xl font-semibold lato text-white'>Ultino <span className='text-[rgb(255,94,12)]'>Resources</span></h1>
                </div>
                ...
                <div className="text-center lg:text-left">
                    ...
                    <ul className="space-y-1.5 text-sm">
                        <li>
                        <Link to={'/about#whoweare'} className="text-white transition hover:text-white/75" href="/">
                            Who We Are
                        </Link>
                        </li>
                        ...
                        <li>
                        <Link to={'/about#mission'} className="text-white transition hover:text-white/75" href="/about/:values">
                            Our Mission
                        </Link>
                        </li>

                        <li>
                        <Link  to={'/about#values'} className="text-white transition hover:text-white/75">
                            Our Core Values
                        </Link>
                        </li>
                    </ul>
                ...
                <div className="text-center lg:text-left">
                    ...
                    <ul className="space-y-1.5 text-sm">
                        <li>
                        <button onClick={()=>handleWork(0)} className="text-white transition hover:text-white/75">
                            Valves And Actuation
                        </button>
                        </li>

                        <li>
                        <button onClick={()=>handleWork(1)} className="text-white transition hover:text-white/75">
                            Measurement Solutions
                        </button>
                        </li>

                        <li>
                        <button onClick={()=>handleWork(2)} className="text-white transition hover:text-white/75">
                            Process Technology
                        </button>
                        </li>

                        <li>
                        <button onClick={()=>handleWork(3)} className="text-white transition hover:text-white/75">
                          E & P
                        </button>
                        </li>

                        <li>
                        <button onClick={()=>handleWork(4)} className="text-white transition hover:text-white/75">
                            SC Management
                        </button>
                        </li>

                        <li>
                        <button onClick={()=>handleWork(5)} className="text-white transition hover:text-white/75">
                            Automation And Control
                        </button>
                        </li>

                        <li>
                        <button onClick={()=>handleWork(6)} className="text-white transition hover:text-white/75">
                            Digital Solutions
                        </button>
                        </li>
                    </ul>
                ...
                <div className="text-center lg:text-left">
                    ...
                    <ul className="space-y-1.5 text-sm">
                        <li>
                        <Link to={'/getaquote'} className="text-white transition hover:text-white/75" >
                            Get A Quote
                        </Link>
                        </li>
                        ...
                        >
                            ...
                            <span
                                className="absolute inline-flex h-full w-full animate-ping rounded-full bg-primaryOrange opacity-75"
                            ></span>
                            <span
                                className="relative inline-flex h-2 w-2 rounded-full bg-primaryOrange"
                            ></span>
                            </span>
                        </Link>
                        </li>
                ...
                <p className="mt-4 text-center lg:text-left">
                    &copy; 2022 Ultino Resources Limited. All rights reserved.
                </p>
                </div>
            </div>
            </div>
